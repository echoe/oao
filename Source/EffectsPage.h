...
public:
    ...
    {
        // Construct rotary FX sliders and map them to APVTS
        auto setupParam = [this] (juce::Slider& slider, juce::Label& label, std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment>& attachment, const juce::String& paramID, const juce::String& labelText)
        {
    ...
    void paint (juce::Graphics& g) override
    {
        ...
        // Header Labels at the top of each effect.
    ...
    {
	// Lay out general knobs for each effect
        auto area = getLocalBounds().reduced (15);
        int sectionWidth = area.getWidth() / 3;
        // --- Chorus Knobs (Column 1) ---
